...
def get_object_types(base_class_name):
    ...
    if base_class_name == 'UnityGame':
        return ('unity.P','unity.S','unity.B','unity.START','unity.PASS','unity.CLICK','None',
                'unity.CUBE_RED','unity.CUBE_BLUE','unity.CUBE_GREEN','unity.CUBE_BLACK','unity.CUBE_BROWN',
                'unity.CUBE_PINK','unity.CUBE_YELLOW','unity.CUBE_GREY','unity.Clicked')
    ...
    if base_class_name == 'UnityGame_reduced':
        return ('unity.P','unity.S','unity.B','unity.START','unity.PASS','unity.Clicked','None')
        # return ('unity.P','unity.P_Clicked','unity.S','unity.S_CLicked','unity.B','unity.START','unity.PASS','unity.CLICK','None')
